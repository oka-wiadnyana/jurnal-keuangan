...
<body>
    ...
    <script src="{{ asset('template_assets') }}/dist/js/app.init.js"></script>
    ...
    <script src="{{ asset('template_assets') }}/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js">
    </script>
    <!--c3 charts -->
